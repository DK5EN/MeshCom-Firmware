...
def drive(transport: Transport, commands: List[str], *,
          ...
          settle_max: float = 40.0) -> Tuple[List[Tuple[str, List[str]]], List[str]]:
...
def render(answers: List[Tuple[str, List[str]]], transport_name: str) -> str:
    import normalize
...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    try:
        answers, async_lines = drive(transport, commands,
                                     quiet=args.quiet, cap=args.cap,
