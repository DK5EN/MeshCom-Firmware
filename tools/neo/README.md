...
| File              | What it does                                                                   |
| ----------------- | ------------------------------------------------------------------------------ |
| `paths/*.txt`     | the chapter cut: which of the 775 paths belongs to which commit                |
...
`K01 CORE K15 K16 K17` are the code cut, 305 paths, disjoint and complete
...
- **`--no-overlay`.** `git checkout <tree> -- <paths>` deletes nothing in its
  default overlay mode. 78 of the 305 paths are deletions.
