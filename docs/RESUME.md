...
| `W5` `R1-02`     | **step 1 done** -- the duplicated three-way phone-framing switch is one host-tested `blePhoneFrame()` (-976 B flash, 32 envs). **Step 2 open:** merging the rings frees 4 920 B but needs a BLE golden before/after on DK5EN-93 |
