...
Open: P0.2 (re-check the audit's line references against the tag), P0.3 and P0.9 (need the bench
nodes plugged in), P0.8 (the BLE golden client, the one tool still missing).
