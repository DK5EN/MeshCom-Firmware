...
| TXM-02  | OPT  | Low  | `src/lora_functions.cpp:1985`            | `RADIO_TX` wird nur an einer der drei Sendestellen gedruckt, und dort nur im Nicht-RAK-Zweig. Auf dem ESP32 feuert es fuer normale MeshCom-Frames (Ping inklusive), nicht fuer TRACK/LoRa-APRS; auf dem RAK nie. Als "Frame ging raus"-Marker also nicht tragfaehig.                                    | offen, faellt mit TXM-01 weg                                                                                                                                                                                                                                                                                           |
