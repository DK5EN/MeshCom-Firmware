...
`TD-12` still owes the 10x double-tap hand test. The operator's "cursor dead time" report then
...
`cdc_backpressure`, `tdeck_cdc_unplug.py`. Still open from today: `TD-12` hand test, `TD-14`,
