...
Last updated 2026-08-30 (§3.8f: TM-34 Wave W shipped — F1–F7 + WPA2-PSK on WPA2/WPA3 APs, 24/24 + 12/12 + 12/12 first joins; TM-35 `[ETH]` instrumentation; HL-01/02, TM-17 fixed). Branch `v4.35p_prio`, rebased onto `upstream/dev`; T-Deck work on `tdeck-partial-refresh-trace`.
