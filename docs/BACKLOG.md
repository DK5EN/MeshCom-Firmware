...
**Wave 1 (2026-08-30 evening, `/orchestrate-waves`):** `RX-01`, `TX-01`, `FL-02`, `CS-01`, `CS-02`, `PT-01` (58 new native cases, 8 parser findings pinned), `TM-42` done and verified on hardware; `TM-38` runner shipped (`apreboot.py`, real run needs the operator at the AP). Native gate 346 cases / 9 envs, four boards built and flashed. Next wave: `BP-01`/`TM-37`, `CS-03`, `TM-39`, `TM-40`, `TM-41`.
