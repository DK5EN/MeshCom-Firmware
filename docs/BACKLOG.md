...
`MH-03`, `MEM-04`, `GPS-07`, `GPS-08`, `GPS-09`, `TD-09`, `TD-10`, `E22-01`, `TLM-01..03`, `MEM-02` (parked),
...
| `GPS-01..04`, `GPS-06`     | **Closed** — the 8 h overnight `DK5EN-14` capture is the bench proof the rows were waiting for: 9791 evaluations, 0 rejects, 0 corrupt samples at the ordinary 3 s cadence. `GPS-07` stays open.                                                      |
