...
| RF-07   | LEAD | Low    | **`taskENTER_CRITICAL()` in `lora_functions.cpp:159/166/174/181` is guarded on `BOARD_RAK4630` alone.** T114 and T-Echo are nRF52 boards on the same FreeRTOS build, so the display-queue critical sections are compiled out there. Noticed during the `RF-02`/`RF-05` guard sweep.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | **OPEN, unverified.** A concurrency question, not a unit question -- filed as a lead, not a claim. Nobody has checked whether those two boards have the same producer/consumer split                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
