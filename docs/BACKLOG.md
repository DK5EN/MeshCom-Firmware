...
`cdc_backpressure`, `tdeck_cdc_unplug.py`. Still open from today: `TD-14` (plan written), `TD-15` (map empty after reboot, filed),
the German PR texts for `TD-12`/`TD-13`/`CDC-01`.
