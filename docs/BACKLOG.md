...
Last updated 2026-08-29 (§3.8f: TM-20 out of the PR, TM-34 WiFi research added, then TM-34 desk half delivered as [`wifi-findings-20260829.md`](wifi-findings-20260829.md)). Branch `v4.35p_prio`, rebased onto `upstream/dev`; T-Deck work on `tdeck-partial-refresh-trace`.
