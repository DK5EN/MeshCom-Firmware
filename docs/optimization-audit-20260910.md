...
| D1-01       | Shared GATE/CONF/BEAT frame handler `handleMeshComUdpFrame()`; platforms keep socket read and link reset behind a plain `McNetOps` function-pointer struct (no vtable)                                                                                                                                                                    | `udp_functions.cpp:205-638` vs `nrf52/nrf_eth.cpp:352-824` (189 identical of 435/473)                                                                                        |                            ~350 | −0.3 kB, −260 B nRF52 stack      | M    | L      | byte-compare UDP 1990 TX and BLE frames on RAK4631 and Heltec V3 via the injectraw EXTUDP recipe                                                            |
