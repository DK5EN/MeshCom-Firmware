...
| ---------------------------- | ------------------------------------------------------ | ------------------ | ---------------------------------------------------------------------------------- |
| aprs_structures.h:20–26      | aprsMessage.msg__*call / msg*__path / msg_gateway_call | String             | Per RX: allocated at frame decode, destroyed after processing                      |
...
Sources: docs/ram-opti.md, docs/ram-comparison-20260514.md, docs/ram-comparison-20260517.md,
...
## 2. Latest measured RAM/Flash (docs/ram-comparison-20260517.md, dated 2026-05-17, HEAD e9edf0df — the newer of the two ram-comparison docs; no more recent snapshot exists in docs/)
...
Interning is _not_ the rejected idea from `docs/ram-opti.md` #12 (S4 §4). That proposal hashed a
...
| R3-13 | `mheardPathBuffer1[100][52]` → `[…][40]`          | `src/mheard_functions.cpp:66`                                                                                   | `ram-opti.md` #12's own cheap recommendation (trim only; hashing stays rejected).                                                                         | +480 / +1 200 / +1 200                         | 0                                                                                                                                 | 0                    | 0                  | M    | none                                                | S      | inject a max-length path frame, check MHeard path output not truncated                                                                             |
...
- **Custom IDF / `sdkconfig` rebuild** (`FREERTOS_PLACE_FUNCTIONS_INTO_FLASH`,
  ...
  Explicitly rejected by `ram-opti.md` #11 and out of scope for an upstream PR. Ceiling is large
