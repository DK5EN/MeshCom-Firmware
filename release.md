# Release Notes -- MeshCom Firmware v4.35q

Entwicklung auf Basis von `oe1kbc_4.35q` (upstream).
Vorgaenger-Version: v4.35p (abgeschlossen, getaggt).

---

<!-- Neue Eintraege hier einfuegen -->
...
please use webflasher https://esptool.oevsv.at for upgrade:
t_deck.bin
t_deck_plus.bin
