// Referenzkopie (MeshCom 5, Welle 2): src/nbr_matrix.cpp aus 886080c4, der
// dichten N x N-Matrix, unveraendert bis auf den Include des eigenen Headers
// und diesen Waechter. Wird NUR von test/test_nbr_replay/test_nbr_replay.cpp
// in "namespace dense { ... }" eingebunden; der Waechter verhindert, dass
// PlatformIOs rekursiver Testquellen-Filter (+<test_nbr_replay/>) die Datei
// zusaetzlich als eigene Uebersetzungseinheit baut und dabei globale
// Symbole (nbrInit, nbrLog, ...) mit dem dichten Layout anlegt.
#ifdef NBR_DENSE_REFERENCE_TU
